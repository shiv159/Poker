...
/** Separate opening deal deck: first Jack or Joker establishes the dealer. */
public final class DealerDeck {
  ...
  private void reset() { cards.clear(); for (char suit : new char[]{'C','D','H','S'}) for (int rank = 2; rank <= 14; rank++) cards.add(new Card(rank, suit)); cards.add(new Card(15, 'X')); cards.add(new Card(15, 'Y')); shuffle(); }
}
