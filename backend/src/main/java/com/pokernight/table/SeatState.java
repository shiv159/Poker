...
public class SeatState {
  ...
  public boolean active() { return betStatus != BetStatus.FOLDED && status != SeatStatus.SITTING_OUT && status != SeatStatus.DISCONNECTED && status != SeatStatus.SPECTATOR; }
}
